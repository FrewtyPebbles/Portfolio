...
export default function Home(props:{route:string, filetree:{data:any, program_name:string, parent_file:string}}) {
...
export async function getStaticProps({ params }:any) {
  ...
  return { props: { route:params.project, filetree:{data:data, program_name:params.project, parent_file:""} } }
}